...
export const EXPLORE_ARTICLES: ExploreArticle[] = [
  ...
  },
  {
    ...
    eyebrow: '身体观察',
    readTime: '约 2 分钟',
    lead: '少量、持续、和自己有关的记录，往往比全面打卡更有用。',
    paragraphs: [
      '可以围绕一个具体困扰选择两到三个相关维度，例如睡眠、压力和疼痛，并记录出现时间和变化。',
      '一段时间后再与过去的自己比较，而不是拿一次记录给身体下结论。',
    ],
    takeaway: '先围绕一个问题收集线索，不必记录所有事情。',
  },
  {
    id: 'health-boundary',
    islandId: 'disease',
    ...
    eyebrow: '健康边界',
    readTime: '约 2 分钟',
    lead: '知识帮助你理解身体，但不能替代专业诊断。',
    paragraphs: [
      '科普提供一般信息，个人记录帮助描述自己的经历；两者都不能单独确认疾病或治疗方案。',
      '当症状持续、加重或影响生活时，应把整理好的线索带给专业医疗人员。',
    ],
    takeaway: '用知识帮助提问，用专业支持处理需要诊断的问题。',
  },
]
